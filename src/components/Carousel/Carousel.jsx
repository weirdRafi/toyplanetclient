        ...
        <div className="carousel w-full h-96 mt-10 shadow-xl">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className='flex items-center '>
                    <div className='mr-32 md:text-3xl ml-10'>
                        ...
                        <button className='btn bg-purple-500 hover:bg-purple-700  mt-5'>Let's Explore  &nbsp;<FontAwesomeIcon icon={faArrowRight} style={{ fontSize: 30 }} className="text-center text-white" /></button>
                    </div>
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide4"><FontAwesomeIcon icon={faArrowLeft} style={{ fontSize: 30 }} className="text-center text-purple-700" /></a>
                        <a href="#slide2"><FontAwesomeIcon icon={faArrowRight} style={{ fontSize: 30 }} className="text-center text-purple-700" /></a>
                    </div>
                </div>
            </div>
            <div id="slide2" className="carousel-item relative w-full">
                ...
                <div className='flex items-center'>
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide1"><FontAwesomeIcon icon={faArrowLeft} style={{ fontSize: 30 }} className="text-center text-purple-700" /></a>
                        <a href="#slide3"><FontAwesomeIcon icon={faArrowRight} style={{ fontSize: 30 }} className="text-center text-purple-700" /></a>
                    </div>
                </div>
            </div>
            <div id="slide3" className="carousel-item relative w-full">
                ...
                <div className='flex items-center'>
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide2"><FontAwesomeIcon icon={faArrowLeft} style={{ fontSize: 30 }} className="text-center text-purple-700" /></a>
                        <a href="#slide4"><FontAwesomeIcon icon={faArrowRight} style={{ fontSize: 30 }} className="text-center text-purple-700" /></a>
                    </div>
                </div>
            </div>
            <div id="slide4" className="carousel-item relative w-full">
                ...
                <div className='flex items-center'>
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide3"><FontAwesomeIcon icon={faArrowLeft} style={{ fontSize: 30 }} className="text-center text-purple-700" /></a>
                        <a href="#slide1"><FontAwesomeIcon icon={faArrowRight} style={{ fontSize: 30 }} className="text-center text-purple-700" /></a>
                    </div>
                </div>
            </div>
        </div>
